...
<Steps>
  ...
  <Step>
    ...
    > [GitHub Enterprise Cloud](https://docs.github.com/en/enterprise-cloud@latest/admin/overview/about-github-enterprise-cloud) uses a custom domain prefix for token endpoints.
    > This prefix can be optionally configured using the `hostName` option (e.g. `acme.ghe.com`).
  </Step>
