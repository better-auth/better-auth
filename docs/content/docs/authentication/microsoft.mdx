...
<Steps>
  <Step>
    ...
    To use Microsoft as a social provider, you need to get your Microsoft credentials. Which involves generating your own Client ID and, for confidential clients, using your Microsoft Entra ID dashboard account either a Client Secret or a client assertion credential.
