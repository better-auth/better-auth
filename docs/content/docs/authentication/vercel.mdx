        ...
        export const auth = betterAuth({ 
            socialProviders: {
                vercel: { // [!code highlight]
                    clientId: process.env.VERCEL_APP_CLIENT_ID as string, // [!code highlight]
                    clientSecret: process.env.VERCEL_APP_CLIENT_SECRET as string, // [!code highlight]
                }, // [!code highlight]
            },
        })
        ```
...
export const auth = betterAuth({
    socialProviders: {
        vercel: {
            clientId: process.env.VERCEL_APP_CLIENT_ID as string,
            clientSecret: process.env.VERCEL_APP_CLIENT_SECRET as string,
