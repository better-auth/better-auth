...
<APIMethod
  ...
  method="GET"
  requireSession
  serverOnlyNote="If you're getting an API key on the server, without access to headers, you can pass the `userId` property instead. This is the ID of the user that the API key belongs to."
>
```ts
type getApiKey = {
    /**
...
<APIMethod
  ...
  method="POST"
  requireSession
  serverOnlyNote="If you're deleting an API key on the server, without access to headers, you can pass the `userId` property instead. This is the ID of the user that the API key belongs to."
...
<APIMethod
  ...
  method="GET"
  requireSession
  serverOnlyNote="If you're listing API keys on the server, without access to headers, you can pass the `userId` property instead. This is the ID of the user whose API keys you want to list."
>
```ts
type listApiKeys = {
    /**
     * User Id of the user whose API Keys you want to list. server-only.
     * @serverOnly
     */
    userId?: string = "user-id"
}
