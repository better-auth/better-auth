...
<Callout>
If you're using the [Custom Session Plugin](/docs/concepts/session-management#customizing-session-response),
this will overwrite the response of the `listDeviceSessions` method.
</Callout>
