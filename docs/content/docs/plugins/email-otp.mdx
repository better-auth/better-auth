...
Properties identified with *signup only* will only affect the automatic signup behavior. It is also possible to pass more properties through [additional fields](/docs/concepts/typescript#additional-fields).
</Callout>
