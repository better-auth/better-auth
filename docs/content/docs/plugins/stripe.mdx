...
- `referenceId`: The ID this subscription is associated with (user ID by default).
- `stripeCustomerId`: The Stripe customer ID.
- `stripeSubscriptionId`: The Stripe subscription ID.
- `status`: The status of the subscription (active, canceled, etc.).
- `periodStart`: The start date of the current billing period.
- `periodEnd`: The end date of the current billing period.
- `cancelAtPeriodEnd`: Whether the subscription will be canceled at the end of the period.
- `seats`: The number of seats for team plans.
- `trialStart`: The start date of the trial period.
- `trialEnd`: The end date of the trial period.
