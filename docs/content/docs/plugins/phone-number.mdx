...
<Steps>
    ...
    <Step>
        ...
        Run the migration or generate the schema to add the necessary fields to your **user** and **otp** tables.
...
The plugin requires 2 fields to be added to the user table and a new table to store OTPs:

### User Table (Add the following fields)
...
<DatabaseTable
    ...
    fields={[
        ...
        { 
            name: "expiresAt", 
            type: "timestamp", 
            description: "The time when the OTP code expires"
        },
    ]}
    />
