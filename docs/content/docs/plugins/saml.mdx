...
<Steps>
    <Step>
        ...
        import { ssoSAML } from "better-auth/plugins/saml";
    ...
    <Step>
        ...
        import { ssoSAMLClient } from "better-auth/plugins/saml/client";

        const authClient = createAuthClient({
            plugins: [ // [!code highlight]
                ssoSAMLClient() // [!code highlight]
            ] // [!code highlight]
        })
        ```
    </Step>
...
The SAML plugin adds the following table to your database:
...
<DatabaseTable
    fields={[
        ...
        },
        {
            name: "issuer",
            type: "string",
            description: "The issuer identifier for the SAML provider",
            isRequired: true,
        },
        {
            name: "samlConfig",
            type: "string",
            description: "The SAML configuration stored as a JSON string",
            isRequired: true,
        },
        {
            name: "providerId",
            type: "string",
            description: "The provider identifier. Used to identify a provider and generate redirect URLs",
            isRequired: true,
            isUnique: true,
        }
    ]}
