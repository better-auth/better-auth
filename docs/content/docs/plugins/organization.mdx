...
Create a new team within an organization. The `slug` must be unique within the organization.
...
type createTeam = {
    ...
    name: string = "my-team"
    /**
     * The slug of the team. Must be unique within the organization.
     */
    slug: string = "my-team"
    /**
...
Check if a team slug is available within an organization.

<APIMethod path="/organization/check-team-slug" method="POST" requireSession>
```ts
type checkTeamSlug = {
    /**
     * The team slug to check.
     */
    slug: string = "my-team"
    /**
     * The organization ID to check the slug against. Defaults to the active organization.
     */
    organizationId?: string = "organization-id"
}
```
...
<DatabaseTable
  fields={[
    ...
    },
    {
      name: "slug",
      type: "string",
      description: "URL-friendly identifier for the team, unique within the organization",
    },
    {
      name: "organizationId",
      type: "string",
