  ...
  plugins: [
    organization({
      organizationHooks: {
        ...
        beforeCreateOrganization: async ({ organization, user }, ctx) => {
        ...
        afterCreateOrganization: async ({ organization, member, user }, ctx) => {
        ...
        beforeUpdateOrganization: async ({ organization, user, member }, ctx) => {
        ...
        afterUpdateOrganization: async ({ organization, user, member }, ctx) => {
  ...
  plugins: [
    organization({
      organizationHooks: {
        ...
        beforeAddMember: async ({ member, user, organization }, ctx) => {
        ...
        afterAddMember: async ({ member, user, organization }, ctx) => {
  ...
  plugins: [
    organization({
      organizationHooks: {
        ...
        beforeAcceptInvitation: async ({ invitation, user, organization }, ctx) => {
        ...
        beforeRejectInvitation: async ({ invitation, user, organization }, ctx) => {
          // Log rejection reason, send notification to inviter
        },

        afterRejectInvitation: async ({ invitation, user, organization }, ctx) => {
