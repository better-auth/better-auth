...
<DatabaseTable
  ...
  fields={[
    ...
    {
      note: "If teams are enabled, you need to add the following fields to the invitation table:",
    },
    {
      fieldName: "teamId",
      type: "string",
...
<DatabaseTable
  ...
  fields={[
    ...
    {
      note: "If teams are enabled:",
    },
    {
      fieldName: "activeTeamId",
      type: "string",
...
### Dynamic Access Control (optional)
  ...
  fields={[
    {
      fieldName: "id",
      type: "string",
      description: "Unique identifier for the organization role",
    },
    {
      fieldName: "organizationId",
      type: "string",
