...
Once you have defined the roles and permissions you can use them in your application. The plugin will automatically check the permissions based on the role of the user on the client. (No need to call the server)
