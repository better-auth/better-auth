...
### Get Active Role Member
To get the current role member of the active organization you can use the `organization.getActiveRoleMember` function. This function will return the user's member role in their active organization.
