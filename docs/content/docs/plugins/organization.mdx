...
To invite multiple users to an organization, you can use the `bulkInvite` function provided by the client. The `bulkInvite` function takes an object with the following properties:
