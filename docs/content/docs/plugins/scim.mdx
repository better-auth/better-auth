...
<APIMethod path="/scim/providers" method="GET" requireSession>
```ts
type listSCIMProviders = {}
```
</APIMethod>
...
<APIMethod path="/scim/providers/:providerId" method="GET" forceAsParam requireSession>
```ts
type getSCIMProvider = {
  /**
...
<APIMethod path="/scim/providers/:providerId" method="DELETE" forceAsParam requireSession>
```ts
type deleteSCIMProvider = {
  /**
   * Unique provider identifier
   */
  providerId: string = "acme-corp"
