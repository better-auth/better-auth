...
<APIMethod path="/scim/provider-connections" method="GET" requireSession>
```ts
...
<APIMethod path="/scim/provider-connections/:providerId" method="GET" forceAsParam requireSession>
```ts
...
<APIMethod path="/scim/provider-connections/:providerId" method="DELETE" forceAsParam requireSession>
```ts
