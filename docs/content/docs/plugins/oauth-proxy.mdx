...
<Steps>
  <Step>
    ...
    The plugin will automatically route OAuth requests through your production server. You do **not** need to set `redirectURI` on your social providers — the plugin handles this internally.
  </Step>
  <Step>
