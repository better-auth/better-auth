...
- `domainWhitelist`: An optional array of strings that allows public invitations to be accepted only from approved domains.
...
<DatabaseTable
  fields={[
    ...
    },
    {
      ...
      type: "string[]",
      description: "A whitelist of domains for a public invitation"
    },
    {
      name: "expiresAt",
      type: "Date",
