...
**refreshTokenParams**: (Optional) Additional query parameters to include in refresh token requests. You can provide a static object or a function that receives `GenericEndpointContext`.
