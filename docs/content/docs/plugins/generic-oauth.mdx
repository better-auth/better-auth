...
- **Gumroad**: No additional required fields. Optional `scopes` (defaults to `["view_profile"]`). Get credentials from [Gumroad Advanced Settings](https://gumroad.com/settings/advanced)
