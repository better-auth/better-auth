...
An endpoint to retrieve the last method a user used to sign in.
...
The name of the cookie used to store the last used login method. Default is `better-auth.last_used_login_method`.
