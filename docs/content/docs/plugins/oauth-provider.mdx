...
Supported signing algorithms: `RS256`, `PS256`, `ES256`, `ES512`, `EdDSA`.
...
<DatabaseTable
  fields={[
    ...
    },
    {
      ...
      type: "string",
      description: "Indicator of requested authentication method for the token endpoint. Supports: ['none', 'client_secret_basic', 'client_secret_post', 'private_key_jwt']",
      isOptional: true,
    },
    {
      name: "jwks",
      type: "string",
      description: "JSON Web Key Set containing the client's public keys for private_key_jwt authentication. Stored as a JSON string.",
      isOptional: true,
    },
    {
      name: "jwksUri",
      type: "string",
      description: "URL for the client's JWK Set endpoint. Must be HTTPS. Mutually exclusive with jwks.",
      isOptional: true,
    },
    {
      name: "grantTypes",
