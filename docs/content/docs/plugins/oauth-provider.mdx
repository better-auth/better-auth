...
Unauthenticated client registration additionally allows for public clients (never confidential) to register without an authorization header. The is especially useful for an MCP to dynamically register themselves as a public client.
