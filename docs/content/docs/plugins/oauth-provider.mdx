...
By default, the token endpoint supports the following built-in grants:
...
<DatabaseTable
  fields={[
    ...
    },
    {
      name: "grantTypes",
      type: "string[]",
      description: "Array of supported grant types. Built-in: 'authorization_code', 'client_credentials', 'refresh_token'. Plugins may register additional grant types.",
      isOptional: true,
    },
    {
      name: "responseTypes",
