...
<APIMethod path="/oauth2/get-client" method="GET">
```ts
type getOAuthClient = {
  /**
...
<APIMethod path="/oauth2/public-client" method="GET">
```ts
...
<APIMethod path="/oauth2/get-clients" method="GET">
```ts
...
<APIMethod path="/oauth2/update-client" method="POST">
```ts
...
<APIMethod path="/oauth2/client/rotate-secret" method="POST">
```ts
...
<APIMethod path="/oauth2/get-consent" method="GET">
```ts
...
<APIMethod path="/oauth2/get-consents" method="GET">
```ts
...
<APIMethod path="/oauth2/update-consent" method="POST">
```ts
type updateOAuthClient = {
  /**
   * The consent id
...
<APIMethod path="/oauth2/delete-consent" method="POST">
```ts
