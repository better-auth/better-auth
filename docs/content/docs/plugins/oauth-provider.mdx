...
You can easily make your APIs [MCP-compatabile](https://modelcontextprotocol.io/specification/draft/basic/authorization) simply by adding a resource server which directs users to this oAuth2.1 authorization server.
