...
Dynamic Client Registration can be utilized with CIMD providing a useful fallback for clients whom may not yet support CIMD.
...
To set the rate client metadata documents should be updated, set `refreshRate` (defaults: "60m"):
