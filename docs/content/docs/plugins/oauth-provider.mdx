...
<Steps>
  ...
  <Step>
    ...
    Always verify against a specified `audience` matching your protected resource. If omitted, the resource client falls back to the authorization server base URL.
