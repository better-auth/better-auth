...
type banUser = {
    /**
     * The user id. If not provided, will default to the session headers.
     */
    userId: string = "user-id"
    /**
...
type userHasPermission = {
     ...
     */
    permissions?: Record<string, string[]> = [{ "project": ["create", "update"] }, { "sale": ["create"] }] /* Must use this, or permission */,
}
```
</APIMethod>
