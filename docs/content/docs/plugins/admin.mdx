...
Organization support is disabled by default.
To enable it, add the following to both your plugin and client plugin options:
...
Allows an admin to list all organizations in the database.

<APIMethod
  path="/admin/list-organizations"
  method="GET"
  requireSession
  resultVariable={"organizations"}
>
```ts
type adminListOrganizations = {
    ...
    query?: {
        ...
        searchValue?: string = "some name"
        /**
         * The field to search in, defaults to name. Can be `slug` or `name`. 
         */
        searchField?: "slug" | "name" = "name"
        /**
         * The operator to use for the search. Can be `contains`, `starts_with` or `ends_with`. 
         */
        searchOperator?: "contains" | "starts_with" | "ends_with" = "contains"
        /**
         * The number of organizations to return. Defaults to 100.
         */
        limit?: string | number = 100
        /**
         * The offset to start from. 
         ...
         * The value to filter by. 
         */
        filterValue?: string | number | boolean = "some-slug"
        /**
         * The operator to use for the filter. 
         */
        filterOperator?: "eq" | "ne" | "lt" | "lte" | "gt" | "gte" = "eq"
...
Allows an admin to list all members of an organization.

<APIMethod
  path="/admin/list-members"
  method="GET"
  requireSession
  resultVariable={"members"}
>
```ts
type adminListMembers = {
    /**
