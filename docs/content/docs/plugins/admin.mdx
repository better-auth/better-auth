...
Use the `getRolePermissions` function on the client side to retrieve all permissions assigned to a specific **role**. This lets you view all permissions assigned to a role directly on the client.
