...
<Card href="https://discord.gg/STqxY92zuS" title="Get help on Discord">
...
```bash
npm i better-auth autumn-js
```

Add `AUTUMN_SECRET_KEY` to your environment variables. You can find it in Autumn's dashboard under "[Developer](https://app.useautumn.com/sandbox/onboarding)".
