...
Note: If you provide email but omit loginHint, Better Auth will automatically use the email as the login_hint for OIDC providers. This does not apply to SAML.
