...
InResponseTo validation uses the verification table, which works correctly in multi-instance deployments (load-balanced servers, serverless, etc.) without additional configuration.
