...
<Callout type="info">
 If you're using Google or other standard OIDC providers, we recommend using Generic OAuth
 instead. Please check whether Generic OAuth covers your use case before requesting the SSO plugin.
</Callout>
...
<TypeTable
  type={{
    ...
    saml: {
        description: "SAML security options for AuthnRequest/InResponseTo validation and timestamp handling.",
        type: "object",
        properties: {
