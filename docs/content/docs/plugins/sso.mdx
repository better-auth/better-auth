...
**schema**: Custom database schema options for the SSO plugin.
...
<TypeTable
  type={{
    ...
    schema: {
        description: "Custom database schema options for the SSO plugin.",
        type: "InferOptionSchema<ReturnType<typeof ssoSchema>>",
        required: false
    },
  }}
/>
