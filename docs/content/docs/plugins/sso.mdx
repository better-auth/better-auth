...
- **Domain verification submission**: `/api/auth/sso/domain-verification`
- **Domain verification validation**: `/api/auth/sso/domain-verification/verify`
