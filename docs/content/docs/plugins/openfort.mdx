...
>>>>>>> 265144ad3 (feat(sidebar): add Openfort link and icon to sidebar content)
=======
    VITE_SHIELD_PUBLISHABLE_KEY=...
>>>>>>> 3f8276588 (fix(docs): improve formatting and clarify optional steps in Openfort documentation)
...
=======
    4. Create a **Policy** for transaction sponsorship
    5. Copy the **Policy ID** to your environment variables
>>>>>>> 265144ad3 (feat(sidebar): add Openfort link and icon to sidebar content)
=======
    4. (optional) Create a **Policy** for transaction sponsorship
    5. (optional) Copy the **Policy ID** to your environment variables
