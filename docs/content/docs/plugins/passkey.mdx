...
### `passkey` table fields: 

- `name`: The name of the passkey.
- `publicKey`: The public key of the passkey.
- `userId`: The id of the user.
- `credentialID`: The unique identifier of the registered credential.
- `counter`: The counter of the passkey.
- `deviceType`: The type of device used to register the passkey.
- `backedUp`: Whether the passkey is backed up.
- `transports`: The transports used to register the passkey.
- `createdAt`: The time when the passkey was created.
