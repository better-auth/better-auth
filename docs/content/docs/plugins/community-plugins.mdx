...
| [better-auth-speckle](https://github.com/XingxinHE/better-auth-speckle) | A plugin for the Speckle System, supporting its non-standard oauth flow with sign-in and link account.                              | <img src="https://github.com/XingxinHE.png" className="rounded-full w-6 h-6 border opacity-70 m-0 inline mr-1" /> [XingxinHE](https://github.com/XingxinHE) |
