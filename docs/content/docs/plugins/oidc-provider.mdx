...
<DatabaseTable
  fields={[
    ...
    },
    {
      name: "clientId", 
      type: "string", 
      description: "Unique identifier for each OAuth client. Field may be mapped to the id field to save an index.",
      isPrimaryKey: true
    },
    { 
      name: "clientSecret", 
      type: "string", 
      description: "Secret key for confidential oAuth clients. Not available for public clients.",
      isOptional: true
    },
    {
      name: "disabled",
    ...
    },
    {
      name: "public",
      type: "string",
      description: "If the oAuth client is a public or confidential client",
      isOptional: true
    },
    { 
      name: "type",
