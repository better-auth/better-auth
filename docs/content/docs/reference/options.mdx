...
Can be configured as a static string, an object with allowed hosts for multi-domain deployments, or a function for fully dynamic per-request resolution.
...
Learn more about dynamic base URL configuration in the [Dynamic Base URL](/docs/concepts/dynamic-base-url) documentation.
