...
- `schema`: Custom Zod schema for the user model. When provided, this schema will be used to define the user table structure and TypeScript types. This takes precedence over additionalFields.
