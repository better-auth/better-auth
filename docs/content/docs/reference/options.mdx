...
By default, Better Auth provides a built-in logger that:
- Uses color-coded output for different log levels
- Prefixes messages with `[Better Auth]`
- Routes messages to appropriate console methods (`console.log`, `console.warn`, `console.error`)
