...
### Option 4: Set the schema name

Pass the `schemaName` option together with your dialect:
...
Run `npx auth@latest generate` to generate a migration file for the specified schema.
