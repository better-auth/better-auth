...
### Skipping generator and datasource blocks

If you want to skip generating the `generator` and `datasource` blocks in your Prisma schema,
you can set the `skipGeneratorAndDatasource` option to `true` in your Prisma adapter configuration.
