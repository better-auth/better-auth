...
| [@proofkit/better-auth](https://github.com/proofgeist/proofkit/tree/main/packages/better-auth)          | [FileMaker OData](https://www.claris.com)  | <img src="https://github.com/eluce2.png" className="rounded-full w-6 h-6 border opacity-70 m-0 inline mr-1" /> [eluce2](https://github.com/eluce2)                |
