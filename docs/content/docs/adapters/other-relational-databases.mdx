...
To use the Kysely adapter, you need to install the `@better-auth/kysely-adapter` package:
...
export const auth = betterAuth({
  database: kyselyAdapter(db, { // [!code highlight]
    type: "postgres", // [!code highlight]
  }), // [!code highlight]
