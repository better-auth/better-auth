...
If you need help with migration, join our [community](/community) or reach out to [contact@better-auth.com](mailto:contact@better-auth.com). You can also reach out for Enterprise support [here](/enterprise).