...
<Steps>
  ...
  <Step>
    ...
    <Tabs items={["Postgres", "MySQL and SQL Server", "SQLite", "Prisma and Drizzle"]}>
      <Tab value="Postgres">
        ```sql
    ...
    The generated index name is `account_issuer_accountId_uidx`. Adjust it if your own migration used another name.
  </Step>
