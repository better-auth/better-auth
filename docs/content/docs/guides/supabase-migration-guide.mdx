...
<Callout type="warn">
You'll lose current active sessions and this guide doesn't cover migrating 2FA, but it should be doable.
</Callout>
...
- [Email and Password](/docs/authentication/email-and-password)
- [Anonymous](/docs/plugins/anonymous)
- [Admin](/docs/plugins/admin)
- [Email OTP](/docs/authentication/email-otp)
