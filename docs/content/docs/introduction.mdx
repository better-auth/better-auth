...
Your auth lives in your codebase. Better Auth fits well into agentic workflows. See [AI Resources](/docs/agent-tools) for **Ask AI** in the docs, **[LLMs.txt](https://www.better-auth.com/llms.txt)**, the **[documentation MCP server](/docs/agent-tools/mcp)** (`https://mcp.better-auth.com/mcp`), and **[Skills](/docs/agent-tools/skills)** for coding assistants.
