...
export const auth = betterAuth({
  ...
  /**
   * You can also use the database hooks to access the additional data.
   * For example, you can set the referredFrom field based on the additional data passed through the OAuth flow.
  */
  databaseHooks: {
    user: {
      create: {
