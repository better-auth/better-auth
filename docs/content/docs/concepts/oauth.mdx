...
| Cloudflare         | User info may omit `email` if the OAuth client does not request a user-details scope such as `user-details.read`                                                         | `profile.sub`                                       | Reliable when present                                                                                                                                               |
