...
Better Auth provides specialized entry points for various frontend frameworks. Using the framework-specific package allows you to access reactive features like Hooks (React). 
...
| SvelteKit          | better-auth/svelte-kit     |
| Vue                | better-auth/vue            |
| Tanstack-start     | better-auth/tanstack-start |
