...
<p className="text-xl text-gray-600 mb-8">
              RevampAI bridges the gap between no-code tools and rigid ERP
              systems, bringing engineers and operators together to solve your
              most critical ops challenges
            </p>
title: Plugins
