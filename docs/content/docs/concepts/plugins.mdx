...
- `isTrustedOrigin`: This is a helper function that allows you to quickly checker whether a given url or path is trusted based on the trusted origins configuration.
