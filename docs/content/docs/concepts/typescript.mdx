...
Better Auth allows you to add additional fields to User, Session, Identity, and Account records. Server APIs infer these fields from the auth configuration. Use `inferAdditionalFields` to carry the public fields into client types.
