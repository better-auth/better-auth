...
By default, if you provide a [secondary storage](/docs/concepts/database#secondary-storage) in your auth configuration, the session will stored in the secondary storage.
