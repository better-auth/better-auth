...
<Callout type="info">
If you don't provide database by default we provide the above configuration for you.
</Callout>
...
This will invalidate all sessions that doesn't match the new version.
</Callout>
