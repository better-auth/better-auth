...
but as a workaround, you can pull your auth options or atlest just least of plugins and other releveant options that could affect the session object and pass it to the plugin.
