---
title: Database
description: Learn how to use databases work with Better Auth.
---
...
<Callout>
Thinking of developing your own database adapter? Check out our [Database Adapter](/docs/guides/create-a-db-adapter) guide.
</Callout>
