...
<Steps>
    ...
    <Step>
        ...
        To initialize Better Auth in your Expo app, you need to call `createAuthClient` with the base url of your Better Auth backend and add the Expo client. Make sure to import the client from `/react`.
