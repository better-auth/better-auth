...
```tsx title="app/socialSignIn.tsx"
...
```tsx title="lib/trpcProvider.tsx"
//...other imports
import { authClient } from "@/lib/authClient"; // [!code highlight]
