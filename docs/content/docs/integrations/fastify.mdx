...
<Callout type="important">
	A configured Better Auth instance is required before proceeding. If you
	haven't set this up yet, please consult our [Installation
...
<Callout type="tip">
	{' '}
	For TypeScript: Ensure your `tsconfig.json` includes `"esModuleInterop": true`
...
<Callout type="warning">
	{' '}
	Always restrict CORS origins in production environments. Use environment
