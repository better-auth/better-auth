...
<Steps>
    ...
    To allow your Electron application to use Better Auth features, ensure that `nodeIntegration` is enabled in your `BrowserWindow` configuration.
