...
<Callout>
	This section is adapted from the [Convex + Better Auth
	guide](https://convex-better-auth.netlify.app/), for more information, please
...
<Callout>
	For a complete example, check out Convex + Better Auth example with Next.js
	[on
	GitHub](https://github.com/get-convex/better-auth/tree/main/examples/next).
</Callout>
