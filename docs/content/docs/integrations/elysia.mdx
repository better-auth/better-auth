...
With Elysia you can use [derive](https://elysiajs.com/essential/handler.html#derive) and [macro](https://elysiajs.com/patterns/macro.html#macro) resolve to create a custom middleware plugin for retrieving the session and user information and adding it to the context for following request.
