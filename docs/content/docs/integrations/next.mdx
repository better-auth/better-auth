...
Better Auth is fully compatible with Next.js 16. However, there are a few changes you should be aware of when upgrading:
...
<Callout type="info">
All Better Auth core functionality works seamlessly with Next.js 16. The changes above are related to Next.js framework updates, not Better Auth itself.
</Callout>
