...
- [Nuxt Better Auth](https://nuxt-better-auth.onmax.me) is an opinionated Nuxt module that provides seamless Better Auth integration with auto-imported composables and middleware.
