...
<Callout type="warn">
**Important: BETTER_AUTH_SECRET Requirements**

Your `BETTER_AUTH_SECRET` **must be at least 32 characters long** and generated with **high entropy**.
...
- Token signing
- PKCE and state parameter generation
- Email verification and password reset encryption

Using a short or weak secret can cause **cryptic runtime errors**, invalid signatures, or weakened security.
</Callout>
