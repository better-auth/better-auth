...
<Callout>
    Configuring a database is optional, but recommended.
    Better-Auth will work in a stateless mode if you don't configure a database.

    The use of plugins will require a database.
</Callout>
