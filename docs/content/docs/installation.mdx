...
<Step>
    ...
    - **Generate**: This command generates an ORM schema or SQL migration file if you're using Kysely. You can also directly apply the migration using the CLI if you're using Kysely.
