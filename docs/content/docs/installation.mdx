...
<Callout type="info">
If you're using a separate client and server setup, make sure to install Better Auth in both parts of your project. (currently better auth only supports web platforms more clients will be added soon)
</Callout>
</Step>
