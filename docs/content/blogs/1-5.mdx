...
description: "Auth CLI, MCP Auth, Electron integration, i18n, adapter extraction, dynamic base URL, Cloudflare D1 support, CLI init wizard, seat-based billing, SAML Single Logout, test utilities, and more!"
date: 2025-02-28
author:
  name: "Alex Yang"
...
tags: ["1.5", "CLI", "MCP", "electron", "i18n", "adapters", "cloudflare", "d1", "stripe", "SSO", "SCIM", "test-utils"]
---
