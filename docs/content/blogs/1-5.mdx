...
description: "Auth CLI, MCP Auth, OAuth 2.1 Provider, Electron integration, i18n, adapter extraction, dynamic base URL, Cloudflare D1 support, CLI init wizard, seat-based billing, SAML Single Logout, test utilities, and more!"
date: 2026-02-28
author:
  name: "Alex Yang"
...
- **Expo**: Fixed immutable headers on Cloudflare Workers and cookie injection wildcards.
