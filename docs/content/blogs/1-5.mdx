...
description: "Auth CLI, MCP Auth, Electron integration, i18n, adapter extraction, dynamic base URL, CLI init wizard, seat-based billing, SAML Single Logout, test utilities, and more!"
date: 2025-02-28
author:
  name: "Alex Yang"
