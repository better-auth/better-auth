---
title: Supabase Auth to PlanetScale + Better Auth Migration Guide
description: This migration guide aims to guide you move your auth from Supabase Auth to Better Auth on PlanetScale.
date: 2025-08-13
author:
  name: "Dagmawi Esayas"
  avatar: "/blogs/bereket.png"
  twitter: "dagmawibabi"
image: "/blogs/supabaseauth-planetscale-guide.png"
tags: ["mugration", "guides", "supabase", "planetscale"]
---

import { HomeIcon } from "lucide-react";
import { Step, Steps } from "fumadocs-ui/components/steps";

# Supabase Auth to PlanetScale + Better Auth Migration Guide

This migration guide aims to guide you move your auth from Supabase Auth to Better Auth on PlanetScale.
...
If you have additional user-related data in Supabase, import it into PlanetScale using their PostgreSQL import tools:
[PlanetScale PostgreSQL Import Guide](https://planetscale.com/docs/postgres/imports/postgres-imports)
