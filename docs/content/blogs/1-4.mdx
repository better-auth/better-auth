...
You can optionally store account info after the OAuth flow in a cookie.
...
Which allows you to use endpoints such as `getAccessToken` to get the access token for your stateless auth setup!
