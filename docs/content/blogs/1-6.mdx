...
Each span carries attributes like `http.route`, `db.operation`, `db.collection.name`, and `better_auth.operation_id` for filtering and grouping in your observability tool.
