...
| Device Authorization schema changes                       | Add the nullable `resource` field, index both code columns, and keep generated codes within 191 characters.                                          |
...
| Device Authorization                           | A new `resource` field, indexed code columns, and 191-character code limits                                  |
