...
export const contents: Content[] = [
	...
	},
	{
		...
		list: [
			...
			{
				title: "Hubspot",
				href: "/docs/authentication/hubspot",
				isNew: true,
				icon: () => (
					<svg
						xmlns="http://www.w3.org/2000/svg"
