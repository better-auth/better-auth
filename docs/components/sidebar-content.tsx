	...
	},
	{
		...
		list: [
			...
			},
			{
				...
				icon: () => (
					<Database className="w-4 h-4 text-current" aria-hidden="true" />
				),
			},
			{
				group: true,
	...
	},
	{
		...
		list: [
			...
			},
			{
				...
				icon: () => (
					<Book className="w-4 h-4 text-current" aria-hidden="true" />
				),
			},

			{
				...
				icon: () => (
					<ShieldCheck className="w-4 h-4 text-current" aria-hidden="true" />
				),
			},
			{
				title: "Telemetry",
				...
				icon: () => (
					<Binoculars className="w-4 h-4 text-current" aria-hidden="true" />
				),
			},
			{
				title: "FAQ",
				...
				icon: () => (
					<CircleHelp className="w-4 h-4 text-current" aria-hidden="true" />
				),
			},
		],
	},
