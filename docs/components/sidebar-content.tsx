...
function contentToPageTree(content: Content): PageTree.Folder {
	return {
		type: "folder",
		icon: <content.Icon aria-hidden="true" />,
		name: content.title,
		index: content.href
			? {
					icon: <content.Icon aria-hidden="true" />,
	...
	},
	{
		...
		list: [
			...
			},
			{
				...
				icon: () => <Database className="w-4 h-4 text-current" aria-hidden="true" />,
			},
			{
				group: true,
				title: "Adapters",
		...
		list: [
			{
				...
				group: true,
				href: "",
				icon: () => <LucideAArrowDown className="w-4 h-4" aria-hidden="true" />,
			},

			{
				title: "Two Factor",
				icon: () => <ScanFace className="w-4 h-4" aria-hidden="true" />,
				href: "/docs/plugins/2fa",
			},
			{
				title: "Username",
				icon: () => <UserSquare2 className="w-4 h-4" aria-hidden="true" />,
				href: "/docs/plugins/username",
			},
			{
				title: "Anonymous",
				icon: () => <UserCircle className="w-4 h-4" aria-hidden="true" />,
			...
			},
			{
				...
				icon: () => <Mailbox className="w-4 h-4" aria-hidden="true" />,
			},
			{
				title: "Email OTP",
	...
	},
	{
		...
		list: [
			...
			},
			{
				...
				icon: () => <Book className="w-4 h-4 text-current" aria-hidden="true" />,
			},

			{
				title: "Security",
				href: "/docs/reference/security",
				icon: () => <ShieldCheck className="w-4 h-4 text-current" aria-hidden="true" />,
			},
			{
				title: "Telemetry",
				href: "/docs/reference/telemetry",
				icon: () => <Binoculars className="w-4 h-4 text-current" aria-hidden="true" />,
			},
			{
				title: "FAQ",
				href: "/docs/reference/faq",
				icon: () => <CircleHelp className="w-4 h-4 text-current" aria-hidden="true" />,
			},
		],
	},
];
