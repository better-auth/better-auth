...
import {
	useResolvedDocsVersions,
	useVersionAvailability,
} from "@/app/docs/provider";
		...
		() =>
			docsVersions.map((version) => {
				...
				return {
					...
					description: version.releaseVersion ?? "Unreleased",
					url,
					urls: new Set([url]),
					props: {
						className: "px-2",
