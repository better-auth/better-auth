	...
	return (
		<Dialog>
			...
			<DialogContent className="@container/create-box px-0! pb-0! max-w-7xl max-h-[85dvh] overflow-clip flex flex-col !rounded-none">
				...
				{/* ensure the grid can shrink so children can respect the max height */}
				<div className="flex-1 min-h-0 grid @5xl:grid-cols-9 border-t md:divide-x">
					<div className="group/preview @5xl:col-span-4 flex min-h-0 relative">
						{/* make the ScrollArea fill available height */}
						<ScrollArea className="size-full min-h-0 relative">
							<div className="absolute opacity-0 group-hover/preview:opacity-100 group-focus-within/preview:opacity-100 transition-opacity top-0 right-0 bg-background p-1 z-20">
								<Button
									size="icon"
									variant="outline"
									className="size-8"
					...
					<div className="@5xl:col-span-5 flex min-h-0">
						<ScrollArea className="size-full min-h-0 [&_[data-radix-scroll-area-viewport]>div]:min-h-full [&_[data-radix-scroll-area-viewport]>div]:flex! [&_[data-radix-scroll-area-viewport]>div]:flex-col">
