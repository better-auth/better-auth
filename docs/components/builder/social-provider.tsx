	...
	atlassian: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M7.12 11.084a.683.683 0 0 0-1.16.126L.075 22.974a.703.703 0 0 0 .611 1.026h8.181a.683.683 0 0 0 .62-.39c2.174-4.47.02-10.028-2.366-12.526m5.563-9.837a12.1 12.1 0 0 0-.34 12.858l4.482 9.889a.704.704 0 0 0 .615.396h8.174a.703.703 0 0 0 .615-1.028L13.3 1.368a.683.683 0 0 0-1.235.005z"
				></path>
			</svg>
		),
		stringIcon: `<svg
	...
	cognito: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M14.883 4.493L8.2 18.583H6.194l7.406-15.66zm5.104 11.57l-3.988 3.944l-1.42-1.42l2.565-2.524l-2.566-2.565l1.42-1.42l3.99 3.985M3.6 7.523l3.99 3.944l-1.42 1.42L3.6 10.363l-2.524 2.524L0 11.467z"
				></path>
			</svg>
		),
		stringIcon: `<svg
	...
	huggingface: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12s12-5.373 12-12S18.627 0 12 0M8.5 9c.828 0 1.5.672 1.5 1.5S9.328 12 8.5 12S7 11.328 7 10.5S7.672 9 8.5 9m7 0c.828 0 1.5.672 1.5 1.5s-.672 1.5-1.5 1.5s-1.5-.672-1.5-1.5s.672-1.5 1.5-1.5m3.642 4.858c-.787 2.366-3.04 4.142-5.642 4.142s-4.855-1.776-5.642-4.142c-.131-.393.08-.82.473-.95a.753.753 0 0 1 .95.472c.656 1.97 2.534 3.62 4.219 3.62s3.563-1.65 4.219-3.62a.753.753 0 0 1 .95-.472c.393.13.604.557.473.95"
				></path>
			</svg>
		),
		stringIcon: `<svg
	...
	kick: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M3 2h18a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1m7.5 4v12H8V6zm2 0l6 6l-6 6h3l4.5-4.5v-3L15.5 6z"
				></path>
			</svg>
		),
		stringIcon: `<svg
	...
	line: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M19.365 9.863c.349 0 .63.285.63.631c0 .345-.281.63-.63.63H17.61v1.125h1.755c.349 0 .63.283.63.63c0 .344-.281.629-.63.629h-2.386c-.345 0-.627-.285-.627-.629V8.108c0-.345.282-.63.63-.63h2.386c.346 0 .627.285.627.63c0 .349-.281.63-.63.63H17.61v1.125zm-3.855 3.016c0 .27-.174.51-.432.596a.653.653 0 0 1-.639-.133L11.21 9.996v2.754a.635.635 0 0 1-.628.629a.635.635 0 0 1-.631-.629V8.108c0-.27.173-.51.43-.595a.656.656 0 0 1 .641.132l3.24 3.347V8.108c0-.345.282-.63.63-.63c.345 0 .63.285.63.63zM9.646 9.863a.635.635 0 0 1-.627.63H7.257v2.755a.635.635 0 0 1-.631.629a.635.635 0 0 1-.627-.629V10.495H4.236a.635.635 0 0 1-.627-.631c0-.346.28-.63.63-.63h5.38c.346 0 .627.285.627.63M24 10.314C24 4.943 18.615.572 12 .572S0 4.943 0 10.314c0 4.811 4.27 8.842 10.035 9.608c.391.082.923.258 1.058.59c.12.301.079.766.038 1.08l-.164 1.02c-.045.301-.24 1.186 1.049.645c1.291-.539 6.916-4.078 9.436-6.975C23.176 14.393 24 12.458 24 10.314"
				></path>
			</svg>
		),
		stringIcon: `<svg
	...
	paypal: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M8.32 23.295c-.26 0-.51-.174-.61-.455L6.113 18.73l-.28.158c-.41.23-.93-.13-.93-.648V11.8c0-.32.18-.59.43-.723l1.64-.87l-1.48-4.174a.72.72 0 0 1-.02-.43c.04-.24.18-.45.39-.56L12.08.577c.27-.15.6-.15.86 0l6.23 4.476c.21.11.35.32.39.56c.04.14.04.29-.02.43l-1.48 4.174l1.64.87c.25.133.43.403.43.723v6.44c0 .518-.52.878-.93.648l-.28-.158l-1.597 4.11a.72.72 0 0 1-.61.455zm-1.3-5.29l1.408 3.618h7.142l1.408-3.618l-4.98-2.81zM12.5 1.75L6.81 5.86l1.44 4.04h7.5l1.44-4.04zM2.23 11.182V7.467c0-.318.183-.588.433-.723l1.645-.87l-1.485-4.174a.72.72 0 0 1-.02-.43c.044-.24.184-.45.394-.56L6.458.133a.754.754 0 0 1 1.078.27c.153.282.06.636-.212.79l-2.73 1.57l1.44 4.04l1.64.87c.25.133.43.405.43.723v6.44c0 .518-.52.878-.93.648l-1.83-1.03l-2.7 5.295a.753.753 0 0 1-1.018.296a.714.714 0 0 1-.303-.992z"
				></path>
			</svg>
		),
		stringIcon: `<svg
	...
	reddit: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M12 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12a12 12 0 0 0 12-12A12 12 0 0 0 12 0m5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 0 1-2.498.056l-2.597-.547l-.8 3.747c1.824.07 3.48.632 4.674 1.488c.308-.309.73-.491 1.207-.491c.968 0 1.754.786 1.754 1.754c0 .716-.435 1.333-1.01 1.614a3.1 3.1 0 0 1 .042.52c0 2.694-3.13 4.87-7.004 4.87c-3.874 0-7.004-2.176-7.004-4.87c0-.183.015-.366.043-.534A1.75 1.75 0 0 1 4.028 12c0-.968.786-1.754 1.754-1.754c.463 0 .898.196 1.207.49c1.207-.883 2.878-1.43 4.744-1.487l.885-4.182a.342.342 0 0 1 .14-.197a.35.35 0 0 1 .238-.042l2.906.617a1.2 1.2 0 0 1 1.108-.701M9.25 12C8.561 12 8 12.562 8 13.25c0 .687.561 1.248 1.25 1.248c.687 0 1.248-.561 1.248-1.249c0-.688-.561-1.249-1.249-1.249m5.5 0c-.687 0-1.248.561-1.248 1.25c0 .687.561 1.248 1.249 1.248c.688 0 1.249-.561 1.249-1.249c0-.687-.562-1.249-1.25-1.249m-5.466 3.99a.327.327 0 0 0-.231.094a.33.33 0 0 0 0 .463c.842.842 2.484.913 2.961.913s2.105-.056 2.961-.913a.36.36 0 0 0 .029-.463a.33.33 0 0 0-.464 0c-.547.533-1.684.73-2.512.73c-.828 0-1.979-.196-2.512-.73a.3.3 0 0 0-.232-.095z"
				></path>
			</svg>
		),
		stringIcon: `<svg
	...
	salesforce: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M10.006 5.43a3.598 3.598 0 0 1 6.538-1.398a4.555 4.555 0 0 1 2.894 1.029a3.923 3.923 0 0 1 4.566 3.845a4.03 4.03 0 0 1-2.68 3.789a3.458 3.458 0 0 1 .396 8.876h-9.216a4.678 4.678 0 0 1-1.665-9.055a4.957 4.957 0 0 1-.833-6.086"
				></path>
			</svg>
		),
		stringIcon: `<svg
	...
	polar: {
		Icon: (props?: SVGProps<any>) => (
			...
			>
				<path
					fill="currentColor"
					d="M12 2L2 7v10l10 5l10-5V7zm0 2.18L19.82 8L12 11.82L4.18 8zM4 9.68l7 3.5v7.64l-7-3.5zm16 0v7.64l-7 3.5v-7.64z"
				></path>
			</svg>
		),
		stringIcon: `<svg
