...
export const socialProviders = {
	...
	line: {
		...
		stringIcon: `<svg
			...
			>
				<title>Log in with LINE</title>
				<defs>
					<g id="line-logo-scaled">
						<path
							fill="#FFFFFF"
							transform="scale(0.35) translate(-81, -44)"
							d="M79.26,23.06C69.45,23.06,61.3,28.7,57.54,37.43c-0.9,2.05-1.44,4.32-1.44,6.75 c0,15.05,14.9,27.25,33.29,27.25c1.39,0,2.76-0.08,4.09-0.23c8.54-1.04,15.98-5.38,21.04-11.95c1.39-1.77,2.16-3.79,2.16-6.01 c0-15.05-14.9-27.25-33.29-27.25S79.26,23.06,79.26,23.06z M85.59,63.04c-1.44,0.15-2.9,0.23-4.39,0.23 c-13.79,0-25-9.04-25-20.18c0-1.92,0.31-3.79,0.88-5.56c3.13-7.74,10-12.75,18.04-12.75c13.79,0,25,9.04,25,20.18 c0,1.84-0.3,3.64-0.84,5.38c-2.86,7.29-9.24,12.14-16.74,12.6l-4.54,0.1 C86.1,63.08,85.85,63.06,85.59,63.04z"
						/>
						<text
							x="0"
							y="4"
				...
				<rect width="40" height="40" rx="5" ry="5" fill="#06C755" />

				<g transform="translate(20, 20)">
					<use xlink:href="#line-logo-scaled" />
				</g>
			</svg>`,
	},
	linkedin: {
