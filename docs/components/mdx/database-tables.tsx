...
import { DBFieldAttribute, DefaultDialects } from "@/lib/copy-schema/types";
...
type CopySchemaDialogData = DatabaseTableProps & {};

type CopySchemaDialogContextState = {
	setOpen: React.Dispatch<React.SetStateAction<boolean>>;
	open: boolean;
	setData: React.Dispatch<
		React.SetStateAction<CopySchemaDialogData | undefined>
	>;
	data: CopySchemaDialogData | undefined;
};
...
export function CopySchemaDialogProvider({
	...
	const [data, setData] = useState<CopySchemaDialogData | undefined>(undefined);
