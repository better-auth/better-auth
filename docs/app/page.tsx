...
export default async function HomePage() {
	...
	return (
		<main className="h-min mx-auto overflow-x-hidden">
			<div className="w-full bg-linear-to-br from-zinc-50 to-zinc-100 dark:from-zinc-950 dark:via-black dark:to-zinc-950 border-b border-dashed border-zinc-200 dark:border-zinc-800">
