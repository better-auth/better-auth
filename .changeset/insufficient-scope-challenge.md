...
- Configure protected scopes with `requiredScopes` through `RequireMcpAuthOptions` or the matching `mcpHandler` verifier option. Exact membership remains the default; `isScopeSatisfied` can define hierarchical policies.
