...
export default async function ChangelogPage() {
	...
	return (
		<div className="flex flex-col lg:flex-row lg:h-dvh lg:overflow-hidden min-h-dvh pt-14 lg:pt-0">
			...
			<div className="relative w-full lg:w-[30%] lg:h-full shrink-0 border-b lg:border-b-0 lg:border-r border-foreground/[0.06] overflow-hidden px-5 sm:px-6 lg:px-10">
				<HalftoneBackground />
				<div className="relative w-full pt-6 md:pt-10 pb-6 lg:pb-0 flex flex-col justify-center lg:h-full">
					<div className="space-y-1">
						...
						<p className="text-[11px] text-foreground/40 leading-relaxed max-w-[240px]">
