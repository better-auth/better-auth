			...
			<div className="flex-1 overflow-y-auto no-scrollbar">
				<div className="p-5 pt-8 lg:p-8 lg:pt-16">
					...
					>
								...
								{[
									...
									>
										<motion.div
											...
											className={cn(
												"group/card relative p-5 lg:p-6 border-foreground/[0.08] min-h-[200px] transition-all duration-200 hover:bg-foreground/[0.02] hover:shadow-[inset_0_1px_0_0_rgba(128,128,128,0.1)] hover:z-10",
										...
										>
											...
											<div className="text-xs font-mono text-neutral-500 dark:text-neutral-400 mb-3 uppercase tracking-wider transition-colors duration-200 group-hover/card:text-neutral-400 dark:group-hover/card:text-neutral-300">
												<span className="text-foreground/60 dark:text-foreground/50 mr-1.5 transition-colors duration-200 group-hover/card:text-foreground/60 dark:group-hover/card:text-foreground/40">
											...
											<div className="text-base font-semibold text-neutral-900 dark:text-neutral-100 leading-snug tracking-tight mb-2 transition-colors duration-200 group-hover/card:text-neutral-950 dark:group-hover/card:text-white">
												{feature.headline}
											</div>
											<div className="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed transition-colors duration-200 group-hover/card:text-neutral-400 dark:group-hover/card:text-neutral-300">
												{feature.desc}
											</div>
						...
						<div className="text-base text-foreground/70 dark:text-foreground/55 mb-8 space-y-1 leading-relaxed">
