...
export interface OpenAPIOptions {
	 ...
	 * @cli optional
	 * @type boolean
	 * @question Should the default reference page be disabled?
	 */
	 ...
	 * @cli optional
	 * @type string
	 * @question What is the theme of the OpenAPI reference page?
	 * @type enum alternate default moon purple solarized bluePlanet saturn kepler mars deepSpace laserwave none
	 */
	theme?: ScalarTheme | undefined;
	/**
	 ...
	 * @cli optional
	 * @type string
	 * @question What is the nonce string to be attached to inline scripts for Content Security Policy (CSP) compliance?
	 */
	nonce?: string | undefined;
}
