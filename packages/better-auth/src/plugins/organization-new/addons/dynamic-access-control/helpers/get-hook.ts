import type {
	DynamicAccessControlHooks,
	ResolvedDynamicAccessControlOptions,
} from "../types";

type HookOptions = "CreateRole" | "UpdateRole" | "DeleteRole";

type Hooks = NonNullable<DynamicAccessControlHooks>;
...
export const getHook = <H extends HookOptions>(
	hook: H,
	options: ResolvedDynamicAccessControlOptions,
) => {
