...
export const apiKey = (options?: ApiKeyOptions) => {
	...
	return {
		...
		endpoints: {
			createApiKey: createAuthEndpoint("/api-key/create", {
				method: "POST",
				body: z.object({
					...
					remaining: z
						...
						.default(null),
					metadata: z
						.any({ description: "Metadata of the Api Key" })
						.optional(),
					refillAmount: z
						.number({
							description:
			...
			verifyApiKey: createAuthEndpoint("/api-key/verify", {
				method: "POST",
				body: z.object({
					key: z.string({
			...
			updateApiKey: createAuthEndpoint("/api-key/update", {
				...
				body: z.object({
					...
					name: z.string({ description: "Name of the Api Key" }).optional(),
					enabled: z
						.boolean({ description: "Enable/Disable the Api Key" })
						.optional(),
					metadata: z
						.any({ description: "Metadata of the Api Key" })
						.optional(),
			...
			deleteApiKey: createAuthEndpoint("/api-key/delete", {
				method: "POST",
				body: z.object({
					id: z.string({
						description: "The id of the Api Key",
			...
			listApiKeys: createAuthEndpoint("/api-key/list", {
				method: "GET",
				use: [sessionMiddleware],
				metadata: {
					openapi: {
