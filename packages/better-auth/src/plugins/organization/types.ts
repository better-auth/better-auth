...
export interface OrganizationOptions {
	...
	/**
	 * If `true`, users must provide their password when initiating an
	 * ownership transfer. Applies to both the email-confirmation flow
	 * and the immediate-transfer flow.
	 *
	 * @default false
	 */
	requirePasswordToTransferOwnership?: boolean | undefined;
	/**
