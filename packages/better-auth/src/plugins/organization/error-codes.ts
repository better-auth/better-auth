...
export const ORGANIZATION_ERROR_CODES = defineErrorCodes({
	...
	YOU_ARE_NOT_ALLOWED_TO_CREATE_A_RESOURCE:
		"You are not allowed to create a resource",
	YOU_ARE_NOT_ALLOWED_TO_UPDATE_A_RESOURCE:
		"You are not allowed to update a resource",
	YOU_ARE_NOT_ALLOWED_TO_DELETE_A_RESOURCE:
		"You are not allowed to delete a resource",
	YOU_ARE_NOT_ALLOWED_TO_READ_A_RESOURCE:
		"You are not allowed to read a resource",
	YOU_ARE_NOT_ALLOWED_TO_LIST_RESOURCES:
		"You are not allowed to list resources",
	...
	RESOURCE_IS_IN_USE:
		"Cannot delete resource because it is being used by existing roles",
