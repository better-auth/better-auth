...
export const deviceAuthorization = (
	...
	return {
		...
		endpoints: {
			...
			deviceToken: implEndpoint(deviceTokenDef, async (ctx) => {
			...
			deviceVerify: implEndpoint(deviceVerifyDef, async (ctx) => {
			...
			deviceApprove: implEndpoint(deviceApproveDef, async (ctx) => {
			...
			deviceDeny: implEndpoint(deviceDenyDef, async (ctx) => {
				const { userCode } = ctx.body;
