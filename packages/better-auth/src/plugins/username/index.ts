...
import { signInUsernameDef, isUsernameAvailableDef } from "./shared";
...
export const username = (options?: UsernameOptions) => {
	...
	return {
		...
		endpoints: {
			signInUsername: implEndpoint(signInUsernameDef, async (ctx) => {
			...
			isUsernameAvailable: implEndpoint(isUsernameAvailableDef, async (ctx) => {
