...
import type { BetterAuthOptions, InferDatabaseModel } from "./types/options";
import type {
...
import type { GenericEndpointContext, Verification } from "./types";
import type { SocialProviderList, SocialProviders } from "./social-providers";
import type { AdapterInstance, SecondaryStorage } from "./types/adapter";
import type { KyselyDatabaseType } from "./adapters/kysely-adapter/types";
import type { Models, RateLimit } from "./types/models";
...
type PrettifyOmitId<T extends Record<string, any>> = PrettifyDeep<
	Omit<T, "id">
>;
...
>(options: {
	...
	// but then we'd have to do that for every other function that uses BetterAuthOptions, which is quite inconvienient
