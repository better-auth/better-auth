...
import type { FieldAttribute, FieldAttributeFor, FieldType } from ".";

export function toZodSchema<
	Fields extends Record<string, FieldAttributeFor<FieldType> | never>,
...
export type FieldAttributeToSchema<
	Field extends FieldAttributeFor<FieldType> | Record<string, never>,
...
type GetType<F extends FieldAttributeFor<FieldType>> = F extends {
	type: "string";
}
	? z.ZodString
...
type GetRequired<
	F extends FieldAttributeFor<FieldType>,
...
type GetInput<
	isClientSide extends boolean,
	Field extends FieldAttributeFor<FieldType>,
	Schema extends z.core.SomeType,
> = Field extends {
	input: false;
}
