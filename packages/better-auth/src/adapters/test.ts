...
export async function runAdapterTest(opts: AdapterTestOptions) {
	...
	test.skipIf(opts.testSkips?.createModel)(
		"create model",
		async () => {
	...
	test.skipIf(opts.testSkips?.findModel)(
		"find model",
		async () => {
	...
	test.skipIf(opts.testSkips?.updateModel)(
		"update model",
		async () => {
	...
	test.skipIf(opts.testSkips?.findMany)(
		"should find many",
		async () => {
	...
	test.skipIf(opts.testSkips?.deleteModel)(
		"delete model",
		async () => {
