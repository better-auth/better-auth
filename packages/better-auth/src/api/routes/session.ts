...
export const getSession = <Option extends BetterAuthOptions>() =>
	implEndpoint(getSessionDef, async (ctx) => {
		try {
...
export const listSessions = <Option extends BetterAuthOptions>() =>
	implEndpoint(listSessionsDef, [sessionMiddleware], async (ctx) => {
		try {
...
export const revokeSession = () =>
	implEndpoint(revokeSessionDef, [sensitiveSessionMiddleware], async (ctx) => {
...
export const revokeSessions = () =>
	implEndpoint(revokeSessionsDef, [sensitiveSessionMiddleware], async (ctx) => {
		try {
