...
import type { Account, BetterAuthPluginDBSchema, RateLimit, Session, User, Verification } from "../db";
...
export type BetterAuthOptions<Schema extends BetterAuthPluginDBSchema<typeof schema>> =
		{
			/**
			...
			databaseHooks?: {
				...
				verification?: {
					...
					update?: {
						 ...
						 */
						before?: (
							verification: Partial<Verification<Schema>> &
