...
/** SQL dialect supported by Better Auth's migration tooling. */
...
/** Parameterized SQL statement executed by a migration connection. */
export interface MigrationDatabaseQuery {
	/** Values bound to the statement's parameter markers. */
	parameters: readonly unknown[];
	/** SQL text using the selected dialect's parameter markers. */
	sql: string;
}

/** Normalized result returned by a migration query. */
export interface MigrationDatabaseQueryResult {
	/** Identifier generated by an insert, when the driver exposes one. */
	insertId?: bigint | undefined;
	/** Number of rows changed by a write statement, when available. */
