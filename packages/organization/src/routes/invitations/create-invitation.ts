...
export const createInvitation = <O extends OrganizationOptions>(
	...
	return createAuthEndpoint(
		...
		async (ctx) => {
			...
			// If resend is true, update the existing invitation's expiration and return
			...
			// If cancelPendingInvitationsOnReInvite is enabled (and resend was not set),
			// cancel the old invitation and fall through to create a new one
