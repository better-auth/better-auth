...
export const ssoTranslations: PluginErrorTranslations<typeof SAML_ERROR_CODES> =
	{
		ar: {
			...
			IDP_SLO_NOT_SUPPORTED:
				"لا يدعم موفر الهوية (IdP) خدمة تسجيل الخروج الموحد",
		...
		de: {
			...
			IDP_SLO_NOT_SUPPORTED:
				"Der IdP unterstützt den Single-Logout-Dienst nicht",
		...
		pl: {
			...
			INVALID_LOGOUT_REQUEST:
				"Nieprawidłowe żądanie wylogowania (LogoutRequest)",
		...
		uk: {
			...
			INVALID_LOGOUT_RESPONSE:
				"Некоректна відповідь про вихід (LogoutResponse)",
