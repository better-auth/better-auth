...
> {
	...
	resources?: string[];
	/**
	 * JWK SHA-256 thumbprint that sender-constrains this access token via DPoP.
	 */
	dpopJkt?: string;
}
...
> {
	...
	resources?: string[];
	/**
	 * JWK SHA-256 thumbprint that sender-constrains this refresh-token family via DPoP.
	 */
	dpopJkt?: string;
}
